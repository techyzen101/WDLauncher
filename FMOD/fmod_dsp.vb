...
Namespace FMOD
    ...
    Public Structure DSP_BUFFER_ARRAY
        Public numbuffers As Integer
        ' [r/w] number of buffers
        Public buffernumchannels As Integer()
        ' [r/w] array of number of channels for each buffer
        Public bufferchannelmask As CHANNELMASK()
        ' [r/w] array of channel masks for each buffer
        Public buffers As IntPtr()
        ' [r/w] array of buffers
        Public speakermode As SPEAKERMODE
    ...
    Public Delegate Function DSP_SETPOSITIONCALLBACK(ByRef dsp_state As DSP_STATE, ByVal pos As UInteger) As RESULT
    Public Delegate Function DSP_READCALLBACK(ByRef dsp_state As DSP_STATE, ByVal inbuffer As IntPtr, ByVal outbuffer As IntPtr, ByVal length As UInteger, ByVal inchannels As Integer, ByRef outchannels As Integer) As RESULT
    Public Delegate Function DSP_SHOULDIPROCESS_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal inputsidle As Boolean, ByVal length As UInteger, ByVal inmask As CHANNELMASK, ByVal inchannels As Integer, ByVal speakermode As SPEAKERMODE) As RESULT
    Public Delegate Function DSP_PROCESS_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal length As UInteger, ByRef inbufferarray As DSP_BUFFER_ARRAY, ByRef outbufferarray As DSP_BUFFER_ARRAY, ByVal inputsidle As Boolean, ByVal op As DSP_PROCESS_OPERATION) As RESULT

    Public Delegate Function DSP_SETPARAM_FLOAT_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByVal value As Single) As RESULT
    Public Delegate Function DSP_SETPARAM_INT_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByVal value As Integer) As RESULT
    Public Delegate Function DSP_SETPARAM_BOOL_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByVal value As Boolean) As RESULT
    Public Delegate Function DSP_SETPARAM_DATA_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByVal data As IntPtr, ByVal length As UInteger) As RESULT
    Public Delegate Function DSP_GETPARAM_FLOAT_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByRef value As Single, ByVal valuestr As IntPtr) As RESULT
    Public Delegate Function DSP_GETPARAM_INT_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByRef value As Integer, ByVal valuestr As IntPtr) As RESULT
    Public Delegate Function DSP_GETPARAM_BOOL_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByRef value As Boolean, ByVal valuestr As IntPtr) As RESULT
    Public Delegate Function DSP_GETPARAM_DATA_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByRef data As IntPtr, ByRef length As UInteger, ByVal valuestr As IntPtr) As RESULT

    Public Delegate Function DSP_SYSTEM_REGISTER_CALLBACK(ByRef dsp_state As DSP_STATE) As RESULT
    Public Delegate Function DSP_SYSTEM_DEREGISTER_CALLBACK(ByRef dsp_state As DSP_STATE) As RESULT
    Public Delegate Function DSP_SYSTEM_MIX_CALLBACK(ByRef dsp_state As DSP_STATE, ByVal stage As Integer) As RESULT

    Public Delegate Function DSP_SYSTEM_GETSAMPLERATE(ByRef dsp_state As DSP_STATE, ByRef rate As Integer) As RESULT
    Public Delegate Function DSP_SYSTEM_GETBLOCKSIZE(ByRef dsp_state As DSP_STATE, ByRef blocksize As UInteger) As RESULT
    Public Delegate Function DSP_SYSTEM_GETSPEAKERMODE(ByRef dsp_state As DSP_STATE, ByRef speakermode_mixer As Integer, ByRef speakermode_output As Integer) As RESULT

    Public Delegate Function DSP_DFT_FFTREAL(ByRef dsp_state As DSP_STATE, ByVal size As Integer, ByVal signal As IntPtr, ByVal dft As IntPtr, ByVal window As IntPtr, ByVal signalhop As Integer) As RESULT
    Public Delegate Function DSP_DFT_IFFTREAL(ByRef dsp_state As DSP_STATE, ByVal size As Integer, ByVal dft As IntPtr, ByVal signal As IntPtr, ByVal window As IntPtr, ByVal signalhop As Integer) As RESULT

    Public Delegate Function DSP_PAN_SUM_MONO_MATRIX(ByRef dsp_state As DSP_STATE, ByVal sourceSpeakerMode As Integer, ByVal lowFrequencyGain As Single, ByVal overallGain As Single, ByVal matrix As IntPtr) As RESULT
    Public Delegate Function DSP_PAN_SUM_STEREO_MATRIX(ByRef dsp_state As DSP_STATE, ByVal sourceSpeakerMode As Integer, ByVal pan As Single, ByVal lowFrequencyGain As Single, ByVal overallGain As Single, ByVal matrixHop As Integer, _
        ByVal matrix As IntPtr) As RESULT
    Public Delegate Function DSP_PAN_SUM_SURROUND_MATRIX(ByRef dsp_state As DSP_STATE, ByVal sourceSpeakerMode As Integer, ByVal targetSpeakerMode As Integer, ByVal direction As Single, ByVal extent As Single, ByVal rotation As Single, _
        ByVal lowFrequencyGain As Single, ByVal overallGain As Single, ByVal matrixHop As Integer, ByVal matrix As IntPtr, ByVal flags As DSP_PAN_SURROUND_FLAGS) As RESULT
    Public Delegate Function DSP_PAN_SUM_MONO_TO_SURROUND_MATRIX(ByRef dsp_state As DSP_STATE, ByVal targetSpeakerMode As Integer, ByVal direction As Single, ByVal extent As Single, ByVal lowFrequencyGain As Single, ByVal overallGain As Single, _
        ByVal matrixHop As Integer, ByVal matrix As IntPtr) As RESULT
    Public Delegate Function DSP_PAN_SUM_STEREO_TO_SURROUND_MATRIX(ByRef dsp_state As DSP_STATE, ByVal targetSpeakerMode As Integer, ByVal direction As Single, ByVal extent As Single, ByVal rotation As Single, ByVal lowFrequencyGain As Single, _
        ByVal overallGain As Single, ByVal matrixHop As Integer, ByVal matrix As IntPtr) As RESULT
    Public Delegate Function DSP_PAN_3D_GET_ROLLOFF_GAIN(ByRef dsp_state As DSP_STATE, ByVal rolloff As DSP_PAN_3D_ROLLOFF_TYPE, ByVal distance As Single, ByVal mindistance As Single, ByVal maxdistance As Single, ByRef gain As Single) As RESULT
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR
        Public numpoints As Integer
        ' [w] The number of <position, value> pairs in the piecewise mapping (at least 2).
        Public pointparamvalues As IntPtr
        ' [w] The values in the parameter's units for each point
        Public pointpositions As IntPtr
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_FLOAT_MAPPING
        Public type As DSP_PARAMETER_FLOAT_MAPPING_TYPE
        Public piecewiselinearmapping As DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_DESC_FLOAT
        ...
        Public mapping As DSP_PARAMETER_FLOAT_MAPPING
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_DESC_INT
        ...
        ' [w] Default parameter value.
        Public goestoinf As Boolean
        ' [w] Whether the last value represents infiniy.
        Public valuenames As IntPtr
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_DESC_BOOL
        Public defaultval As Boolean
        ' [w] Default parameter value.
        Public valuenames As IntPtr
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_DESC_DATA
    ...
    Public Structure DSP_PARAMETER_DESC_UNION
        <FieldOffset(0)> _
        Public floatdesc As DSP_PARAMETER_DESC_FLOAT
    ...
    Public Structure DSP_PARAMETER_DESC
        ...
        Public desc As DSP_PARAMETER_DESC_UNION
    End Structure
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_OVERALLGAIN
        Public linear_gain As Single
        ' [r] The overall linear gain of the effect on the direct signal path
        Public linear_gain_additive As Single
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_3DATTRIBUTES
        Public relative As _3D_ATTRIBUTES
        ' [w] The position of the sound relative to the listener.
        Public absolute As _3D_ATTRIBUTES
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_3DATTRIBUTES_MULTI
        Public numlisteners As Integer
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_SIDECHAIN
        Public sidechainenable As Integer
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_PARAMETER_FFT
    ...
    Public Structure DSP_DESCRIPTION
        Public pluginsdkversion As UInteger
        ...
        Public numinputbuffers As Integer
        ...
        Public numoutputbuffers As Integer
        ...
        Public process As DSP_PROCESS_CALLBACK
        ...
        Public sys_register As DSP_SYSTEM_REGISTER_CALLBACK
        ...
        Public sys_deregister As DSP_SYSTEM_DEREGISTER_CALLBACK
        ...
        Public sys_mix As DSP_SYSTEM_MIX_CALLBACK
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_STATE_DFTCALLBACKS
        Public fftreal As DSP_DFT_FFTREAL
        ' [r] Callback for performing an FFT on a real signal.
        Public inversefftreal As DSP_DFT_IFFTREAL
        ' [r] Callback for performing an inverse FFT to get a real signal.
    End Structure
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_STATE_PAN_CALLBACKS
        Public summonomatrix As DSP_PAN_SUM_MONO_MATRIX
        Public sumstereomatrix As DSP_PAN_SUM_STEREO_MATRIX
        Public sumsurroundmatrix As DSP_PAN_SUM_SURROUND_MATRIX
        Public summonotosurroundmatrix As DSP_PAN_SUM_MONO_TO_SURROUND_MATRIX
        Public sumstereotosurroundmatrix As DSP_PAN_SUM_STEREO_TO_SURROUND_MATRIX
        Public getrolloffgain As DSP_PAN_3D_GET_ROLLOFF_GAIN
    End Structure
    ...
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure DSP_STATE_SYSTEMCALLBACKS
        Private alloc As MEMORY_ALLOC_CALLBACK
        ' [r] Memory allocation callback. Use this for all dynamic memory allocation within the plugin.
        Private realloc As MEMORY_REALLOC_CALLBACK
        ' [r] Memory reallocation callback.
        Private free As MEMORY_FREE_CALLBACK
        ' [r] Memory free callback.
        Private getsamplerate As DSP_SYSTEM_GETSAMPLERATE
        ' [r] Callback for getting the system samplerate.
        Private getblocksize As DSP_SYSTEM_GETBLOCKSIZE
        ...
        Private dft As IntPtr
        ' [r] Struct containing callbacks for performing FFTs and inverse FFTs.
        Private pancallbacks As IntPtr
        ' [r] Pointer to a structure of callbacks for calculating pan, up-mix and down-mix matrices.
        Private getspeakermode As DSP_SYSTEM_GETSPEAKERMODE
    ...
    Public Structure DSP_STATE
        ...
        Public channelmask As UInteger
        ' [r] Specifies which speakers the DSP effect is active on
        Public source_speakermode As Integer
    ...
    Public Class DSP_METERING_INFO
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=32)> _
        Public peaklevel As Single()
        ' [r] The peak level per channel.
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=32)> _
        Public rmslevel As Single()
    ...
    Public Enum DSP_RETURN
        ...
        INPUT_SPEAKER_MODE
        ' (Type:int) - Input speaker mode of this return. Default = FMOD_SPEAKERMODE_DEFAULT.
    End Enum
    ...
    Public Enum DSP_PAN
        ...
        SURROUND_DIRECTION
        ' (Type:float) - Surround pan direction ROTATION_MIN to ROTATION_MAX. Default = 0.0.
        SURROUND_EXTENT
        ' (Type:float) - Surround pan extent EXTENT_MIN to EXTENT_MAX. Default = 360.0.
        SURROUND_ROTATION
        ' (Type:float) - Surround pan rotation ROTATION_MIN to ROTATION_MAX. Default = 0.0.
        SURROUND_LFE_LEVEL
        ...
        ' (Type:int) - Surround Speakers Enabled. 0 to 0xFFF. Default = 0xFFF.
        _3D_POSITION
        ' (Type:data) - 3D Position data of type FMOD_DSP_PARAMETER_DATA_TYPE_3DPOS
        _3D_ROLLOFF
        ...
        _3D_MIN_DISTANCE
        ' (Type:float) - 3D Min Distance 0.0 to GAME_UNITS_MAX. Default = 1.0.
        _3D_MAX_DISTANCE
        ' (Type:float) - 3D Max Distance 0.0 to GAME_UNITS_MAX. Default = 20.0.
        _3D_EXTENT_MODE
        ...
        _3D_SOUND_SIZE
        ' (Type:float) - 3D Sound Size 0.0 to GAME_UNITS_MAX. Default = 0.0.
        _3D_MIN_EXTENT
        ' (Type:float) - 3D Min Extent EXTENT_MIN to EXTENT_MAX. Default = 0.0.
        _3D_PAN_BLEND
        ' (Type:float) - 3D Pan Blend PAN_BLEND_MIN to PAN_BLEND_MAX. Default = 0.0.
        LFE_UPMIX_ENABLED
        ' (Type:int) - LFE Upmix Enabled 0 to 1. Default = 0.
        OVERALL_GAIN
        ' (Type:data) - Overall Gain data of type FMOD_DSP_PARAMETER_DATA_TYPE_OVERALLGAIN
